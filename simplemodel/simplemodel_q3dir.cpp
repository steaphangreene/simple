...
SimpleModel_Q3Dir::SimpleModel_Q3Dir(const string &pack, const string &filenm,
                                     const string &defskin) {
  head = NULL;
  torso = NULL;
...
bool SimpleModel_Q3Dir::Load(const string &pack, const string &filenm,
                             const string &defskin) {
...
const vector<string> &SimpleModel_Q3Dir::GetSkinList() { return skins; }
