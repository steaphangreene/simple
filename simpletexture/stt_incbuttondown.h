...
#ifndef STT_INCBUTTONDOWN_H
#define STT_INCBUTTONDOWN_H

#include "stt_button.h"

class STT_IncButtonDown : public STT_Button {
public:
  STT_IncButtonDown(const SDL_Color &txtcol);
protected:
