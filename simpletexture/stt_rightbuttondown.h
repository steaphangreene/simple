...
#ifndef STT_RIGHTBUTTONDOWN_H
#define STT_RIGHTBUTTONDOWN_H

#include "stt_button.h"

class STT_RightButton_Down : public STT_Button {
 public:
  STT_RightButton_Down(const SDL_Color &txtcol);
