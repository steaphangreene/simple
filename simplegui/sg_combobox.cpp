...
const string &SG_ComboBox::Text() { return text->Text(); }

void SG_ComboBox::SetText(const string &itms) { text->SetText(itms); }

const string &SG_ComboBox::Item(int opt) { return menu->Item(opt); }
...
int SG_ComboBox::NumItems() { return menu->NumItems(); }

void SG_ComboBox::Set(int which) { text->SetText(menu->Item(which)); }
