...
void SG_PullDown::SetID(int id) { menu->SetID(id); }

int SG_PullDown::ID() { return menu->ID(); }

const string &SG_PullDown::Item(int opt) { return menu->Item(opt); }

int SG_PullDown::NumItems() { return menu->NumItems(); }

void SG_PullDown::SetItems(const vector<string> &itms) { menu->SetItems(itms); }
