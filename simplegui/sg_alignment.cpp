...
bool SG_Alignment::HandEventTo(SG_Widget *targ, SDL_Event *event, float x,
                               float y) {
...
void SG_Alignment::UnsetBackground() { background = NULL; }
...
void SG_Alignment::EnableEdgeEvents() { last_edge_event = SG_EDGE_NONE; }

void SG_Alignment::DisableEdgeEvents() { last_edge_event = 0; }
