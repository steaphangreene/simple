...
void SG_Ranger::Increment() { SetValue(value + inc); }

void SG_Ranger::Decrement() { SetValue(value - inc); }

float SG_Ranger::Value() { return value; }

float SG_Ranger::Min() { return min; }

float SG_Ranger::Max() { return max; }
