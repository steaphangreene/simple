...
void SG_Ranger2D::SetXIncrement(float i) { xranger.SetIncrement(i); }

void SG_Ranger2D::XIncrement() { xranger.Increment(); }

void SG_Ranger2D::XDecrement() { xranger.Decrement(); }

void SG_Ranger2D::SetYIncrement(float i) { yranger.SetIncrement(i); }

void SG_Ranger2D::YIncrement() { yranger.Increment(); }

void SG_Ranger2D::YDecrement() { yranger.Decrement(); }
...
void SG_Ranger2D::LinkXTo(SG_Ranger *other) { xranger.LinkTo(other); }

void SG_Ranger2D::LinkYTo(SG_Ranger *other) { yranger.LinkTo(other); }
...
void SG_Ranger2D::LinkXFrom(SG_Ranger *other) { xranger.LinkFrom(other); }

void SG_Ranger2D::LinkYFrom(SG_Ranger *other) { yranger.LinkFrom(other); }
