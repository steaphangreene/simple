...
bool SG_Positional::HandEventTo(SG_Widget *targ, SDL_Event *event, float x,
                                float y) {
...
bool SG_Positional::AddWidget(SG_Widget *wid, const float xoff,
                              const float yoff, const float xsize,
                              const float ysize, bool modal) {
