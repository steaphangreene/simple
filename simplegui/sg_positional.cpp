...
SG_Positional::SG_Positional(float xbor, float ybor)
	: SG_Alignment(xbor, ybor),
	  SG_Ranger2D(0.0, 0.0, 0.5, 0.5, 0.0, 0.0, 1.0, 1.0) {
  }
...
bool SG_Positional::Render(unsigned long cur_time) {
//  fprintf(stderr, "Rendering Positional %p!\n", this);
...
void SG_Positional::RangerChanged() {
